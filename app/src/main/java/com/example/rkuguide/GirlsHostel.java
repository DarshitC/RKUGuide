...
public class GirlsHostel extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        slideModels.add(new SlideModel(R.drawable.girlsh1, ScaleTypes.FIT));
        slideModels.add(new SlideModel(R.drawable.girlsh2, ScaleTypes.FIT));
        slideModels.add(new SlideModel(R.drawable.girlsh3, ScaleTypes.FIT));
